...
const ingresoModel = __importStar(require("../models/ingreso.model"));
const getIngresosPorDia = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const resultado = yield ingresoModel.getIngresosPorDia();
        res.json(resultado);
    }
    catch (err) {
        console.error(err);
...
const getIngresosPorTipo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const resultado = yield ingresoModel.getIngresosPorTipo();
        res.json(resultado);
    }
    catch (err) {
        console.error(err);
...
const getIngresosPorCentro = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const resultado = yield ingresoModel.getIngresosPorCentro();
        res.json(resultado);
    }
    catch (err) {
        console.error(err);
...
const getIngresosPorMetodo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const resultado = yield ingresoModel.getIngresosPorMetodo();
        res.json(resultado);
    }
    catch (err) {
        console.error(err);
...
const getIngresosPorCarrera = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const resultado = yield ingresoModel.getIngresosPorCarrera();
        res.json(resultado);
    }
    catch (err) {
        console.error(err);
